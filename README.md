Este projeto utiliza Cypress e Mocha para realizar testes automatizados em uma aplicação web. O objetivo é garantir a qualidade e confiabilidade da aplicação.
